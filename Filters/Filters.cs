...
namespace Priem
{
    public partial class Filters : Form
    {
        ...
        private void FillFilters()
        {
            ...
            AddItem(new FilterItem("Фамилия", FilterType.Text, "ed.extPerson.Surname", "ed.extPerson"));
            AddItem(new FilterItem("Имя", FilterType.Text, "ed.extPerson.Name", "ed.extPerson"));
            AddItem(new FilterItem("Отчество", FilterType.Text, "ed.extPerson.SecondName", "ed.extPerson"));
            AddItem(new FilterItem("Дата Рождения", FilterType.DateFromTo, "ed.extPerson.BirthDate", "ed.extPerson"));
            AddItem(new FilterItem("Номер паспорта", FilterType.FromTo, "ed.extPerson.PassportNumber", "ed.extPerson"));
            AddItem(new FilterItem("Серия паспорта", FilterType.FromTo, "ed.extPerson.PassportSeries", "ed.extPerson"));
            AddItem(new FilterItem("Дата выдачи паспорта", FilterType.DateFromTo, "ed.extPerson.PassportDate", "ed.extPerson"));
            AddItem(new FilterItem("Пол мужской?", FilterType.Bool, "ed.extPerson.Sex", "ed.extPerson"));
            AddItem(new FilterItem("Страна", FilterType.Multi, "ed.extPerson.CountryId", "ed.extPerson", " SELECT ed.Country.Id, ed.Country.Name FROM ed.Country ORDER BY Name "));
            AddItem(new FilterItem("Гражданство", FilterType.Multi, "ed.extPerson.NationalityId", "ed.extPerson", " SELECT ed.Country.Id, ed.Country.Name FROM ed.Country ORDER BY Name "));
            AddItem(new FilterItem("Регион", FilterType.Multi, "ed.extPerson.RegionId", "ed.extPerson", " SELECT Id, Name FROM ed.Region "));
            AddItem(new FilterItem("Телефон", FilterType.Text, "ed.extPerson.Phone", "ed.extPerson"));
            AddItem(new FilterItem("Предоставлять общежитие на время поступления", FilterType.Bool, "ed.extPerson.HostelAbit", "ed.extPerson"));
            AddItem(new FilterItem("Выдано направление на поселение", FilterType.Bool, "ed.extPerson.HasAssignToHostel", "ed.extPerson"));
            AddItem(new FilterItem("Выдан экзаменационный пропуск", FilterType.Bool, "ed.extPerson.HasExamPass", "ed.extPerson"));
            AddItem(new FilterItem("Факультет, выдавший направление", FilterType.Multi, "ed.extPerson.HostelFacultyId", "ed.extPerson", " SELECT Id, Name FROM ed.SP_Faculty "));
            AddItem(new FilterItem("Желает изучать англ с нуля", FilterType.Bool, "ed.extPerson.StartEnglish", "ed.extPerson"));
            AddItem(new FilterItem("Сдает ЕГЭ в СПбГУ", FilterType.Bool, "ed.extPerson.EgeInSpbgu", "ed.extPerson"));

            AddItem(new FilterItem("Приоритет", FilterType.Multi, "ed.qAbiturient.Priority", "ed.qAbiturient", " SELECT DISTINCT Priority AS Id, Priority AS Name FROM ed.qAbiturient "));
            ...
            AddItem(new FilterItem("Предоставлять общежитие на время обучения", FilterType.Bool, "ed.extPerson.HostelEduc", "ed.extPerson"));
            ...
            AddItem(new FilterItem("Зачислен в СПбГУ (человек)", FilterType.Bool, " EXISTS (SELECT Top(1) ed.extEntryView.Id FROM ed.extEntryView INNER JOIN ed.extAbit ON ed.extabit.id = ed.extentryview.abiturientid WHERE ed.extabit.PersonId = ed.extPerson.Id)", "ed.extPerson"));
            ...
            //льготы
            AddItem(new FilterItem("Военнослужащий", FilterType.Bool, "ed.extPerson.Privileges & 4 ", "ed.extPerson"));
            AddItem(new FilterItem("Сирота", FilterType.Bool, "ed.extPerson.Privileges & 1 ", "ed.extPerson"));
            AddItem(new FilterItem("Чернобылец", FilterType.Bool, "ed.extPerson.Privileges & 2 ", "ed.extPerson"));
            AddItem(new FilterItem("Полусирота", FilterType.Bool, "ed.extPerson.Privileges & 16 ", "ed.extPerson"));
            AddItem(new FilterItem("Инвалид", FilterType.Bool, "ed.extPerson.Privileges & 32 ", "ed.extPerson"));
            AddItem(new FilterItem("Уч. боев.", FilterType.Bool, "ed.extPerson.Privileges & 64 ", "ed.extPerson"));
            AddItem(new FilterItem("Стажник", FilterType.Bool, "ed.extPerson.Privileges & 128 ", "ed.extPerson"));
            AddItem(new FilterItem("Реб.-сирота", FilterType.Bool, "ed.extPerson.Privileges & 256 ", "ed.extPerson"));
            AddItem(new FilterItem("Огр. возможности", FilterType.Bool, "ed.extPerson.Privileges & 512 ", "ed.extPerson"));
            ...
            AddItem(new FilterItem("Образовательная программа", FilterType.Multi, "ed.qAbiturient.ObrazProgramId", "ed.qAbiturient", " SELECT DISTINCT ed.qEntry.ObrazProgramId AS Id, ed.qEntry.ObrazProgramName + ' (' + ed.qEntry.ObrazProgramCrypt + ')' AS Name FROM ed.qEntry WHERE StudyLevelGroupId = " + MainClass.studyLevelGroupId));
            ...
            if (MainClass.dbType != PriemType.PriemMag)
            {
                ...
                AddItem(new FilterItem("Статус ФБС", FilterType.Multi, "(SELECT FBSStatusId FROM ed.extFBSStatus WHERE ed.extFBSStatus.PersonId = ed.extPerson.Id)", "ed.extPerson", "SELECT Id, Name FROM ed.FBSStatus WHERE Id <> 3"));
                ...
                //ЕГЭ
                AddItem(new FilterItem("Номер свидетельства ЕГЭ 2011 года", FilterType.FromTo, " (SELECT Top(1) ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2011)", "ed.extPerson"));
                AddItem(new FilterItem("Номер свидетельства ЕГЭ 2012 года", FilterType.FromTo, " (SELECT Top(1) ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2012)", "ed.extPerson"));
                AddItem(new FilterItem("Номер свидетельства ЕГЭ 2013 года", FilterType.FromTo, " (SELECT Top(1) ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2013)", "ed.extPerson"));
                AddItem(new FilterItem("Загружено cвид-во ЕГЭ 2014 года", FilterType.Bool, "EXISTS (select Top(1) ed.EgeCertificate.IsImported FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND Year=2014 AND IsImported > 0)", "ed.extPerson"));
                AddItem(new FilterItem("Сдавал ЕГЭ", FilterType.Bool, " EXISTS (SELECT ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id)", "ed.extPerson"));

                AddItem(new FilterItem("Есть свидетельство ЕГЭ 2014 года", FilterType.Bool, " EXISTS (SELECT ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2014)", "ed.extPerson"));
                AddItem(new FilterItem("Есть свидетельство ЕГЭ 2013 года", FilterType.Bool, " EXISTS (SELECT ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2013)", "ed.extPerson"));
                AddItem(new FilterItem("Есть свидетельство ЕГЭ 2012 года", FilterType.Bool, " EXISTS (SELECT ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2012)", "ed.extPerson"));
                AddItem(new FilterItem("Есть свидетельство ЕГЭ 2011 года", FilterType.Bool, " EXISTS (SELECT ed.EgeCertificate.Number FROM ed.EgeCertificate WHERE ed.EgeCertificate.PersonId = ed.extPerson.Id AND ed.EgeCertificate.Year = 2011)", "ed.extPerson"));


                AddItem(new FilterItem("Апелляция", FilterType.Bool, " EXISTS (SELECT * FROM ed.EgeMark LEFT JOIN ed.EgeCertificate ON ed.EgeMark.EgeCertificateId = ed.EgeCertificate.Id WHERE ed.EgeMark.IsAppeal>0 AND ed.EgeCertificate.PersonId = ed.extPerson.Id) ", "ed.extPerson"));
                AddItem(new FilterItem("Из олимпиад", FilterType.Bool, " EXISTS (SELECT * FROM ed.EgeMark LEFT JOIN ed.EgeCertificate ON ed.EgeMark.EgeCertificateId = ed.EgeCertificate.Id WHERE ed.EgeMark.IsFromOlymp>0 AND ed.EgeCertificate.PersonId = ed.extPerson.Id) ", "ed.extPerson"));            
            ...
            {
                AddItem(new FilterItem("Номер диплома", FilterType.FromTo, "ed.extPerson.DiplomNum", "ed.extPerson"));

                AddItem(new FilterItem("Название учебного заведения", FilterType.Text, "ed.extPerson.HightEducation", "ed.extPerson"));
                AddItem(new FilterItem("Год окончания учебного заведения", FilterType.FromTo, "ed.extPerson.HEExitYear", "ed.extPerson"));

                AddItem(new FilterItem("Профиль", FilterType.Multi, "ed.qAbiturient.ProfileId", "ed.qAbiturient", " SELECT DISTINCT ed.qProfile.Id, ed.qProfile.Name AS Name FROM ed.qProfile "));
                
                AddItem(new FilterItem("Красный диплом", FilterType.Bool, "ed.extPerson.IsExcellent", "ed.extPerson"));
            }
